...
Одна библиотека (#Far regex#) встроена в библиотеку LuaFAR и, таким образом,
всегда доступна. Для подключения библиотек #Oniguruma# и #PCRE#, в системе
должны присутствовать следующие файлы:
   Oniguruma : onig.dll (на %PATH% или %FARHOME%)
        PCRE : pcre.dll (на %PATH% или %FARHOME%)
...
(схемами), как с единым целым: создавать, загружать, переименовывать и удалять.
 ...
 #Ins#   - сохранить текущий набор установок диалога как схему
 #Del#   - удалить схему
