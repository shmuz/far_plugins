...
Имеется 4 переключаемые метода фильтрации:
 ...
 \3BВсе истории\-
   ...
   #Ctrl-Shift-Ins#     Скопировать все отфильтрованные пункты в буфер
                      обмена.
   #Shift-Del#          Удалить текущий пункт из истории.
   #Ctrl-Del#           Удалить все отфильтрованные пункты из истории.
   #Del#                Очистить фильтр.
   #Ctrl-V#, #Shift-Ins#  Установить фильтр в строку из буфера обмена.
 ...
 \3BИстория команд\-
   ...
   #Alt-F11#            Переключиться на историю просмотра/
                      редактирования.
 ...
 \3BИстория просмотра/редактирования\-
   ...
   #Ctrl-PgDn#          Перейти к файлу (на активной панели) и открыть
                      его.
