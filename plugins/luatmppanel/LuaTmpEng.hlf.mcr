...
with them at the same time.
 ...
 #Save panels on FAR exit#
   Save the common panels' contents in a file immediately before the FAR exits.
When FAR is run again, the contents will be automatically restored.
...
$ #Temporary panel: list files#
   ...
   Lines not matching any of the conditions mentioned above are not
added to the panel.
